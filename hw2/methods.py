...
class LineSearchTool(object):
    ...
    def line_search(self, oracle, x_k, d_k, previous_alpha=None):
        ...
        if self._method == 'Constant':
            ...
            return self.armijo_search(oracle, x_k, d_k, previous_alpha)
    ...
    def armijo_search(self, oracle, x_k, d_k, alpha_0):
        foo_alpha = oracle.func_directional(x_k, d_k, alpha_0)
        foo_0 = oracle.func_directional(x_k, d_k, 0)

        grad_0 = oracle.grad_directional(x_k, d_k, 0)

        while foo_alpha > foo_0 + self.c1 * alpha_0 * grad_0:
            alpha_0 /= 2
            foo_alpha = oracle.func_directional(x_k, d_k, alpha_0)
        return alpha_0
